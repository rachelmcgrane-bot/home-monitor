...
async def analyse_frame(image_bytes: bytes, enrolled_persons: list[dict]) -> dict:
    ...
    prompt = (
        ...
        '  "task": one concise sentence describing what the person is doing,\n'
        '  "activity_type": MUST be one of exactly: "cleaning", "cooking", "eating", "tv", "resting", "personal", "family", "other",\n'
        '    (personal = on phone/tablet, sitting leisurely, personal phone call, self-care;\n'
        '     family = helping children, kids homework, playing with kids, getting kids ready, family errands;\n'
        '     resting = lying down, napping, genuinely inactive),\n'
        '  "confidence": float 0.0-1.0 for identity match confidence,\n'
        '  "etiquette_violation": null or brief description of any etiquette issue,\n'
