...
async def analyse_frame(image_bytes: bytes, enrolled_persons: list[dict]) -> dict:
    ...
    prompt = (
        ...
        '    "family"    — directly and actively interacting with or supervising the children:\n'
        '                  playing a game together, helping with homework, feeding a child,\n'
        '                  getting children dressed/ready, reading to a child.\n\n'
